...
void GenerateRandomWord(int number_of_words, int length_of_word);
void SortRandomlyGeneratedWords(int number_of_words);
...
int main()
{
    ...
    GenerateRandomWord(number_of_strings,length_of_string); //calls the function to generate random words
    SortRandomlyGeneratedWords(number_of_strings);         //calls the function to sort the randomly generated words in alphabetical order
...
void GenerateRandomWord (int number_of_words, int length_of_word)  // function takes the number of words and the length of the words as arguments
...
//|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//===========================================================================================================================
void SortRandomlyGeneratedWords(int number_of_words) // function takes the number of words as an argument and sorts the previously generated words in alphabetical order.
